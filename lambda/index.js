...
exports.handler = async (event) => {
    try {
        ...
        const daysInAdvance = parseInt(process.env.DAYS) || 5;
        let date = Date.now();

        // plus specified number of days
        ...
        const bookResponse = await axios.request(configBook);
        console.log(JSON.stringify(bookResponse.data));
